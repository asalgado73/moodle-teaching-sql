...
$sqlpreguntas = $DB->get_records_sql('SELECT * FROM pregunta WHERE id = 4', array(1));
...
<table width="958" height="402" border="0" align="center">
  ...
  <tr>
    <td><img src="img/ej4.png" width="650" height="250" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>       <label>'
  ...
  <tr>
    ...
    <td><form id="form2" name="form2" method="post" action="escenario5.php">
        <p>
          <label></label>
        </p>
        <p align="center">' 
