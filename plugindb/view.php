...
echo $OUTPUT->heading('<div align="center">
  <table width="214" border="1">
    <tr>
      <td width="99"><form id="form2" name="form2" method="post" action="escenario.php">
        <p>
          <label></label>
        </p>
        <p align="center">' 
          ...
          '
          . '
          <input type="submit" name="Submit" value="Insertar Escenario" />
          <br />
        </p>
      </form>      </td>
    </tr>
	<tr>
      <td width="99"><form id="form2" name="form2" method="post" action="view_1.php">
        <p>
          <label></label>
        </p>
        <p align="center">' 
          ...
          '
          . '
          <input type="submit" name="Submit" value="Crear Evaluaci&oacute;n" />
          <br />
        </p>
      </form>      </td>
    </tr>
	<tr>
      <td width="99"><form id="form2" name="form2" method="post" action="view_3.php">
        <p>
          <label></label>
        </p>
        <p align="center">' 
          ...
          '
          . '
          <input type="submit" name="Submit" value="Realizar Evento" />
          <br />
        </p>
      </form>      </td>
    </tr>
    <tr>
    <td width="99"><form id="form2" name="form2" method="post" action="view_4.php">
        <p>
          <label></label>
        </p>
        <p align="center">' 
          ...
          '
          . '
          <input type="submit" name="Submit" value="Consultar notas" />
          <br />
        </p>
      </form>      </td>
  </table>
