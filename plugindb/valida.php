...
$insertardato = $DB->insert_record('pregunta', $ejercicio);
...
<table width="958" height="402" border="0" align="center">
  ...
  <tr>
    <td><img src="img/ej1.png" width="650" height="250" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><label>'
  ...
  <tr>
    <td><a href="valida.php">respuesta</a>
    </td>
    <td><form id="form2" name="form2" method="post" action="escenario2.php">
        <p>
          <label></label>
        </p>
        <p align="center">' 
