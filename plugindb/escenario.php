...
//$sqlpreguntas = $DB->get_records_sql('SELECT * FROM pregunta');
...
echo $OUTPUT->heading('<div>
  <table width="580" border="0" cellspacing="2" align="center">
    <tr>
		<td>Creacion de Escenario </td>
      	<td>&nbsp;</td>
    </tr>
    <tr>
      <th scope="row">Nombre:</th>
      <td><form id="form1" name="form1" method="post" action="escenario1.php" enctype="multipart/form-data">
        <input type="text" name="textfield" />
      </td>
    </tr>
  
    <tr>
      <th scope="row">Script de creaci&oacute;n:</th>
      <td>
